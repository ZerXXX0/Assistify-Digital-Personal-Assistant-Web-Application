...
public class NoteServlet extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        db.connect();
        if (db.isConnected()) {
            ResultSet rs = db.getDataS("SELECT id, title, textNote, voiceNote, createdDate FROM note ORDER BY id ASC");
            request.setAttribute("listNote", rs);
    ...
    public String getServletInfo() {
        return "Servlet untuk menampilkan data catatan";
    }
}
