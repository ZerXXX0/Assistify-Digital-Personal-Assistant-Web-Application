...
public class JournalEntryServlet extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        db.connect();
        if (db.isConnected()) {
            ResultSet rs = db.getDataS("SELECT id, title, content, entryDate, mood FROM journalentry ORDER BY id ASC");
            request.setAttribute("listJournal", rs);
    ...
    public String getServletInfo() {
        return "Servlet untuk menampilkan data jurnal harian";
    }
}
